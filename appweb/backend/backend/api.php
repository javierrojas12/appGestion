...
/*
    # Definir el tipo de petición
    switch ($peticion['metodo']) {
        case 'cuentasporcobrar':
            $url = $server . '/apilira-gestion/dashboard/cuentas_por_cobrar';
            break;

        case 'cuentasporpagar':
            $url = $server . '/apilira-gestion/dashboard/cuentas_por_pagar';
            break;

        case 'ventasgastosrentabilidad':
            $url = $server . '/apilira-gestion/dashboard/ventas_gastos_rentabilidad';
            break;
            
        case 'flujo_de_caja':
            $url = $server . '/apilira-gestion/dashboard/flujo_de_caja';
            break;
